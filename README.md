...
<p align="center">
  <img src="./assets/02_property_counts_over_time.png" alt="Property counts over time by category" width="100%">
</p>
...
- `README.md` — the GitHub-ready report
- `./assets/` — extracted figures used by the report
- `SF_assessor_roll.ipynb` — Jupyter Notebook with full codes and analyses
- `SF_assessor_roll.html` — html print out of the Jupyter Notebook results
